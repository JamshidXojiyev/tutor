...
const ru = {
  ...
  form: {
    ...
    category: "Категория",
    creativePotential: "Информация о творческом потенциале студентов",
    music: "Интересы к музыке",
    art: "Интересы к искусству и литературе",
  ...
  admin: {
    ...
    delete_soon: "Этот раздел скоро будет добавлен!",
  },
};
